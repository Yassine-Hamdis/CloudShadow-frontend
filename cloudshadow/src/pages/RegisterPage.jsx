...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      storeLogin(data)
      toast.success(`Welcome to CloudShadow, ${data.companyName}!`)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl relative z-10 grid lg:grid-cols-[0.95fr_1.05fr] rounded-[2rem] overflow-hidden app-panel">
        <div className="hidden lg:flex flex-col justify-between p-10 bg-[linear-gradient(180deg,rgba(15,23,36,0.2),rgba(63,81,181,0.22))] border-r border-white/5">
          ...
          <div className="max-w-sm">
            <h1 className="text-4xl font-semibold text-[#E6EEF2] leading-tight mb-4">
              Build your monitoring workspace.
            </h1>
            <p className="text-sm text-[#9AA6B2] leading-7">
              Add your team, connect servers, and start tracking health in minutes.
            </p>
          </div>

          <div className="grid grid-cols-3 gap-3 text-xs text-[#9AA6B2]">
            <div className="rounded-2xl border border-white/8 bg-white/4 p-3">Teams</div>
            <div className="rounded-2xl border border-white/8 bg-white/4 p-3">Servers</div>
            <div className="rounded-2xl border border-white/8 bg-white/4 p-3">Alerts</div>
          </div>
        </div>
            ...
            <div>
              ...
              <input
                ...
                className={`
                  ...
                  ${errors.companyName ? 'border-[#E53935]' : 'border-[#374151]/70'}
                `}
              />
              {errors.companyName && (
                <p className="text-xs text-[#E53935] mt-1">{errors.companyName}</p>
              )}
            </div>
